 ...
 */
//static
bool RayIntersectionTest::intersect(const glm::vec3& ray_start, const glm::vec3&  ray_stop, vector<glm::vec3> object, Material& material, vector<glm::vec3>& intersect_list)
{
//#define TEST
#ifdef TEST
    glm::vec3 s(2,0,10);
  ...
  //  glm::vec3 v2(70,5,0); vertices.push_back(v2);
    ...
    glm::mat4 m = material.model_matrix;
    glm::mat4 mInv = glm::inverse(m);
    
	vector<glm::vec3> vertices = object;
