...
{    
	...
	vec4 texture0_color = texture(texture0,pass_Texture);
	vec4 texture1_color = texture(texture1,pass_Texture);
	vec4 texture2_color = texture(texture2,pass_Texture);
	vec4 texture3_color = texture(texture3,pass_Texture);
	
	if (blend_mode == 0){	
		color = mixed + texture0_color + 0.1*texture1_color;
